...
from pr_ngvla.config import ERA5_MONTHLY_DIR, COAST_SHP, MUNI_SHP, OUT_MAPS, NOAA_ISD_DIR
...
def load_data():
    ...
    clim_rate = monthly_climatology(ds["tp"])
    clim      = precip_to_mm_month(clim_rate)
